...
use EmissorNfse\Providers\Webiss\V2_02\Request\ConsultarNfsePorFaixaRequest;
...
// ###############################################
// Exemplo de como consultar nota fiscal dentro de uma faixa de numeração utilizando o serviço "ConsultarNfsePorFaixa"
// Obs: os valores utilizados abaixo são meramente demostrativos
// Todas as opções SET disponíveis na classe ConsultarNfsePorFaixaRequest podem ser obtidas no manual de uso
...
$request = new ConsultarNfsePorFaixaRequest();

$request->setCnpjPrestador('04335479000124');
$request->setInscricaoMunicipalPrestador('1986');
$request->setNumeroNfseInicial('202000000000023');
$request->setNumeroNfseFinal('202000000000024');
$request->setPagina(1);
