...
use EmissorNfse\Providers\Webiss\V2_02\Request\ConsultarNfseServicosPrestadosRequest;
...
// ###############################################
// Exemplo de como consultar notas fiscais emitidas utilizando o serviço "ConsultarNfseServicoPrestado"
// Obs: os valores utilizados abaixo são meramente demostrativos
// Todas as opções SET disponíveis na classe ConsultarNfseServicoPrestadoRequest podem ser obtidas no manual de uso
...
$request = new ConsultarNfseServicosPrestadosRequest();

$request->setCnpjPrestador('04377769000124');
