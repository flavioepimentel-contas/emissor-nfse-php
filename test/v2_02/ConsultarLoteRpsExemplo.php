...
use EmissorNfse\Providers\Webiss\V2_02\Request\ConsultarLoteRpsRequest;
...
// ###############################################
// Exemplo de como consultar notas fiscais emitidas utilizando o serviço "ConsultarLoteRps"
...
$request->setCnpjPrestador('04338775000124');
$request->setInscricaoMunicipalPrestador('1986');
$request->setProtocolo('1595688377243');
