...
// ###############################################
// Exemplo de como cancelar uma nota fiscal utilizando o serviço "CancelarNfse"
// Obs: os valores utilizados abaixo são meramente demostrativos
// Todas as opções SET disponíveis na classe CancelarNfseRequest podem ser obtidas no manual de uso
...
$request->setCnpjPrestador('04337669000124');
$request->setInscricaoMunicipalPrestador('1986');
$request->setCodigoMunicipioGerador('3100401');
$request->setNumeroNfseCancelar('202000000000024');
...
if(! empty($response->erros)){
    ...
    if(! empty($response->dataCancelamento)){
        // Cancelou a NFSe
        // ........
