...
namespace EmissorNfse\Providers\Webiss\V1_00\Helpers;
...
class Soap extends Response
{
    ...
    public function send($request){
        ...
        //$message = str_replace('{body}',  $xml , $envelop);
 ...
 // var_dump($callResult); exit;
            ...
            if (is_object($callResult)){
                ...
                if(empty($callResult) || ! is_object($callResult)){
                    $callResult = $soap->__getLastResponse();
                }
            }
