...
class SubstituirNfseResponse extends Response
{

    public $nfseSubstituida = null;
    public $nfseSubstituidora = null;

    public function __construct()
    {
        //$this->nfseSubstituidora = new Nfse();
       // $this->nfseSubstituida = new Nfse();
    }

    public function parseXml($xml){
        if (stripos($xml, 'SubstituirNfseResposta') === false){
        ...
        try{
            ...
            $nfseSubstituida = ($dom->getElementsByTagName('NfseSubstituida')->length > 0) ?
                $dom->getElementsByTagName('NfseSubstituida')->item(0) : null;

            if(! empty($nfseSubstituida)){

                $nota = new Nfse();

                $infNfse = ($nfseSubstituida->getElementsByTagName('InfNfse')->length > 0) ?
                    $nfseSubstituida->getElementsByTagName('InfNfse')->item(0) : null;
                ...
                $nfseCancelamento = ($nfseSubstituida->getElementsByTagName('NfseCancelamento')->length > 0) ?
                    $nfseSubstituida->getElementsByTagName('NfseCancelamento')->item(0) : null;
                ...
                $nfseSubstituicao = ($nfseSubstituida->getElementsByTagName('NfseSubstituicao')->length > 0) ?
                    $nfseSubstituida->getElementsByTagName('NfseSubstituicao')->item(0) : null;
                ...
                if(! empty($nota->numeroNfse)){
                    $this->nfseSubstituida = $nota;
                }


            } // End if nfseSubstituida

            // ************************
            $nota = null;
            $nfseSubstituidora = ($dom->getElementsByTagName('NfseSubstituidora')->length > 0) ?
                $dom->getElementsByTagName('NfseSubstituidora')->item(0) : null;

            if(! empty($nfseSubstituidora)){
                $nota = new Nfse();

                $infNfse = ($nfseSubstituidora->getElementsByTagName('InfNfse')->length > 0) ?
                    $nfseSubstituidora->getElementsByTagName('InfNfse')->item(0) : null;
                ...
                $nfseCancelamento = ($nfseSubstituidora->getElementsByTagName('NfseCancelamento')->length > 0) ?
                    $nfseSubstituidora->getElementsByTagName('NfseCancelamento')->item(0) : null;
                ...
                $nfseSubstituicao = ($nfseSubstituidora->getElementsByTagName('NfseSubstituicao')->length > 0) ?
                    $nfseSubstituidora->getElementsByTagName('NfseSubstituicao')->item(0) : null;
                ...
                if(! empty($nota->numeroNfse)){
                    $this->nfseSubstituidora = $nota;
                }

            } // End if $nfseSubstituidora
