...
class GerarNfseResponse extends Response
{
                ...
                if(! empty($declaracaoPrestacaoServico)){
                    ...
                    if(! empty($servico)){
                        ...
                        if(empty($this->nfse->valorIss)){
                            $this->valorIss = ($servico->getElementsByTagName('ValorIss')->length > 0) ?
                        ...
                        $this->nfse->municipioIncidencia = ($servico->getElementsByTagName('MunicipioIncidencia')->length > 0) ?
                    ...
                    $this->nfse->icentivoFiscal = ($declaracaoPrestacaoServico->getElementsByTagName('IncentivoFiscal')->length > 0) ?
