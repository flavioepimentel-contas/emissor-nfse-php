...
class ConsultarNfseServicosPrestadosRequest
{
    const SYS_DS = DIRECTORY_SEPARATOR;
    private $abrasfVersion = '2.02';
    private $action = 'ConsultarNfseServicoPrestado';
    private $soapHelper = '\\EmissorNfse\\Providers\\Webiss\\V2_02\\Helpers\\Soap';
    private $responseNamespace = '\\EmissorNfse\\Providers\\Webiss\\V2_02\\Response\\ConsultarNfseServicosPrestadosResponse';
    ...
    {
        $this->templatePath = __dir__ . self::SYS_DS . '..' . self::SYS_DS . 'Template' . self::SYS_DS . 'ConsultarNfseServicosPrestados.xml'  ;
    }
    ...
    {
        $this->cnpjTomador = preg_replace('/[\.\-\/]/', '', $CpfCnpjTomador);
    }
     ...
     */
    public function setCnpjIntermediario($cpfCnpjIntermediario)
    {
    ...
    public function getEnvelopString(){
        return '<ConsultarNfseServicoPrestadoRequest xmlns="http://nfse.abrasf.org.br">
