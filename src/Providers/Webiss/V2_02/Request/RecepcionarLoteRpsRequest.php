...
class RecepcionarLoteRpsRequest
{
    ...
    private $responseNamespace = '\\EmissorNfse\\Providers\\Webiss\\V2_02\\Response\\RecepcionarLoteRpsResponse';
    ...
    public function getEnvelopString(){
        ...
        return '<RecepcionarLoteRpsRequest xmlns="http://nfse.abrasf.org.br">
