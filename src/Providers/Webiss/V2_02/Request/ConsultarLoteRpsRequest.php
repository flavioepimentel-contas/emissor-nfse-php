...
class ConsultarLoteRpsRequest
{
    ...
    private $responseNamespace = '\\EmissorNfse\\Providers\\Webiss\\V2_02\\Response\\ConsultarLoteRpsResponse';
    ...
    public function getEnvelopString(){
        return '<ConsultarLoteRpsRequest xmlns="http://nfse.abrasf.org.br">
